"""Deterministically seed fixtures/iface_repo as a git repo.
...
FIXTURE_DIR = Path(__file__).resolve().parent.parent / "fixtures" / "iface_repo"
...
def ensure_seeded_iface(fixture_dir: Path = FIXTURE_DIR) -> str:
    """Create/commit the fixture repo if needed; return HEAD SHA."""
    if not (fixture_dir / "services.py").exists():
    ...
    if not git_dir.exists():
        ...
        _git("commit", "-m", "seed: iface_repo v1", cwd=fixture_dir)
