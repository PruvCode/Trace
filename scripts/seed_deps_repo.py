"""Deterministically seed fixtures/deps_repo as a git repo.
...
FIXTURE_DIR = Path(__file__).resolve().parent.parent / "fixtures" / "deps_repo"
...
def ensure_seeded_deps(fixture_dir: Path = FIXTURE_DIR) -> str:
    ...
    if not git_dir.exists():
        ...
        _git("commit", "-m", "seed: deps_repo v1", cwd=fixture_dir)
