"""Deterministically seed fixtures/api_repo as a git repo.
...
FIXTURE_DIR = Path(__file__).resolve().parent.parent / "fixtures" / "api_repo"
...
def ensure_seeded_api(fixture_dir: Path = FIXTURE_DIR) -> str:
    """Create/commit the fixture repo if needed; return HEAD SHA."""
    if not (fixture_dir / "router.py").exists():
    ...
    if not git_dir.exists():
        ...
        _git("commit", "-m", "seed: api_repo v1", cwd=fixture_dir)
